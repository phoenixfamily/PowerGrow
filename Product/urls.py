...
urlpatterns = [
    path('sports/', sport_view, name='sport-view'),
    path('categories/<int:pk>/', category_view, name='category-view'),
    ...
    path('session/create/', create_session_view, name='create-session-view'),
